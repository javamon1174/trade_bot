...
class Account:
    ...
    def buy(self, currency='eth', price=None, qty=None, **kwargs):
        """
        make a buy order.
    ...
    def sell(self, currency='eth', qty=None, price=None, **kwargs):
        """
        make a sell order.
